...
class AddClient extends Component {
  ...
  handleFormSubmit(formProps) {
    this.props.addCompany({...formProps, type: this.state.type, order:'client'});
  ...
  render() {
    ...
    const actions = [
      <FlatButton
        label="Cancel"
        primary={true}
        onClick={this.props.closeAddClient}
      />,
    <RaisedButton
        label="Submit"
        primary={true}
    ...
    return (
      <Dialog
        ...
        modal={false}
        open={true}
        onRequestClose={this.props.closeAddClient}
        ...
        <form onSubmit={handleSubmit(this.handleFormSubmit.bind(this))}>
          ...
          <MuiGeoSuggest
                ...
                hintText="Fill in company location"
                floatingLabelFixed={true}
                fullWidth={true}
                {...location}
            />
...
}, mapStateToProps, actions)(AddClient);
